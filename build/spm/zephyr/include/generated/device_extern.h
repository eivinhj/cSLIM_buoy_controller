...
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_chipselect);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_chipselect_S_cs_display);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_chipselect_S_cs_fram);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_chipselect_S_cs_gps);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_chipselect_S_cs_lora);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_chipselect_S_cs_sd);
...
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_gps_gpio);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_gps_gpio_S_gps_enable);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_gps_gpio_S_gps_timepulse);
...
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_rs232_gpio);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_rs232_gpio_S_rs232_nshdn);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_rs485_gpio);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_rs485_gpio_S_rs485_de);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_rs485_gpio_S_rs485_re);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_rs485_gpio_S_rs485_rx);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_rtc_gpio);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_rtc_gpio_S_rtc_clkout);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_rtc_gpio_S_rtc_nint);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_sd_gpio);
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_sd_gpio_S_sd_enable);
...
extern const struct device DEVICE_DT_NAME_GET(DT_N_S_soc_S_peripheral_50000000_S_spi_b000_S_sdhc_0);
